...
# enc = encoding3.TwinWidthEncoding2(g, cubic=2, sb_static=0, sb_ord=False, sb_static_full=False, sb_static_diff=False, is_grid=False)
result = enc.run(g, slv.Cadical, 2, steps_limit=steps_limit, write=True)
