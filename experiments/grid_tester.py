...
g, steps_limit = grid_2d_graph(6, 6), 50
...
enc = encoding3.TwinWidthEncoding2(g, cubic=2, sb_static=1, sb_ord=False, sb_static_full=True, sb_static_diff=True, break_g_symmetry=False)
