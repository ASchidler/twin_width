"""Part of the twin-width numbers. Exports the data in nauty_limits.py. Note that nauty_limits.py is auto-generated by runner_nauty."""
    ...
    for i, c_str in enumerate(v):
        ...
        if len(g.nodes) > 2:
            ...
            for n1 in glb:
                ...
                lb = max(lb, clb)
            print(f"{lb}")
            enc = encoding3.TwinWidthEncoding2(g)
            # enc = encoding.TwinWidthEncoding()
            cb, od, mg = enc.run(g, Cadical195, ub, check=True)
